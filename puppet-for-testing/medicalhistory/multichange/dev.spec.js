...
describe("Test header and title of the page", () => {
  ...
  test('Multi add medical history', async () => {
    ...
    await patientProfile.waitForSelector('#each-data-row-0-medical_history > div > div > #diagnosis > .v-tribute > .el-input__inner')
    await patientProfile.click('#each-data-row-0-medical_history > div > div > #diagnosis > .v-tribute > .el-input__inner')

    await patientProfile.type('#each-data-row-0-medical_history > div > div > #diagnosis > .v-tribute > .el-input__inner','test')
    await patientProfile.waitForTimeout(500);
    ...
    await patientProfile.type('div > div > #description > .v-tribute > .valid-dirty-data','test1')
    await patientProfile.waitForTimeout(500);

    await patientProfile.waitForSelector('#each-data-row-1-medical_history > div > div > #diagnosis > .v-tribute > .el-input__inner')
    await patientProfile.click('#each-data-row-1-medical_history > div > div > #diagnosis > .v-tribute > .el-input__inner')

    await patientProfile.type('#each-data-row-1-medical_history > div > div > #diagnosis > .v-tribute > .el-input__inner','test12')
    await patientProfile.waitForTimeout(500);

    await patientProfile.waitForSelector('#each-data-row-1-medical_history > div > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.click('#each-data-row-1-medical_history > div > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.type('#each-data-row-1-medical_history > div > div > #description > .v-tribute > .el-textarea__inner','test123')
    await patientProfile.waitForTimeout(500);
  ...
  test('multichange medical history', async () => {
    await patientProfile.waitForSelector('div:nth-child(3) > div > div > .A4 > div > div:nth-child(9) > div > div > b')
    await patientProfile.click('div:nth-child(3) > div > div > .A4 > div > div:nth-child(9) > div > div > b')
    ...
    await patientProfile.waitForSelector('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(2) > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.click('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(2) > div > #description > .v-tribute > .el-textarea__inner')

    await patientProfile.evaluate(function() {
        document.querySelector('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(2) > div > #description > .v-tribute > .el-textarea__inner').value = ''
    })
    await patientProfile.type('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(2) > div > #description > .v-tribute > .el-textarea__inner','test123')

    await patientProfile.waitForSelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #diagnosis > .v-tribute > .el-input__inner')
    await patientProfile.click('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #diagnosis > .v-tribute > .el-input__inner')

    await patientProfile.evaluate(function() {
        document.querySelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #diagnosis > .v-tribute > .el-input__inner').value = ''
    })
    await patientProfile.type('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #diagnosis > .v-tribute > .el-input__inner','test1234')
    ...
    await patientProfile.type('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner','test12345')
