...
describe("Test header and title of the page", () => {
  ...
  test('multi add plan comments', async () => {
    ...
    await patientProfile.waitForSelector('#each-data-row-1-plan_comments > div > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.click('#each-data-row-1-plan_comments > div > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.type('#each-data-row-1-plan_comments > div > div > #description > .v-tribute > .el-textarea__inner','test2')
    await patientProfile.waitForTimeout(500);
  ...
  test('Delete multiple plan comments', async () => {
    await patientProfile.waitForSelector('div:nth-child(2) > div > div > .A4 > div > div:nth-child(8) > div > div > b')
    await patientProfile.click('div:nth-child(2) > div > div > .A4 > div > div:nth-child(8) > div > div > b')
    await patientProfile.waitForTimeout(500);
