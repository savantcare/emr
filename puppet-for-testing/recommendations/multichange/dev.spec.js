...
describe("Test Recommendation for Multi Change", () => {
  ...
  test('Multi Change recommendations skill', async () => {
    await ptProfilePage.waitForSelector('div:nth-child(2) > div > div > .A4 > div > div:nth-child(6) > div > div > b');
    await ptProfilePage.click('div:nth-child(2) > div > div > .A4 > div > div:nth-child(6) > div > div > b');
    await ptProfilePage.waitForTimeout(500);
    ...
    await ptProfilePage.waitForSelector('#pane-recommendations div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-recommendations div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-recommendations div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-recommendations div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner','multiChangeText');
