...
describe("Test header and title of the page", () => {
  ...
  test('add examination', async () => {
    ...
    await patientProfile.waitForSelector('#pane-examination > div > div > div > div:nth-child(2) > div:nth-child(4) > div #div-containing-all-buttons > div:nth-child(2) > .el-button')
    await patientProfile.click('#pane-examination > div > div > div > div:nth-child(2) > div:nth-child(4) > div #div-containing-all-buttons > div:nth-child(2) > .el-button')
  ...
  test('single edit examination', async () => {
    await patientProfile.waitForSelector('div > div:nth-child(14) > div > div > b')
    await patientProfile.click('div > div:nth-child(14) > div > div > b')
  
    await patientProfile.waitForSelector('#pane-examination > div > div > div > div:nth-child(2) > div:nth-child(4) > div #div-containing-all-buttons > div:nth-child(3) > .el-button')
    await patientProfile.click('#pane-examination > div > div > div > div:nth-child(2) > div:nth-child(4) > div #div-containing-all-buttons > div:nth-child(3) > .el-button')
    await patientProfile.waitForTimeout(1000);
