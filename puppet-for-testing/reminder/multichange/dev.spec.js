...
describe("Test header and title of the page", () => {
  ...
  test('Multi change reminder skill', async () => {
    await patientProfile.waitFor(500);

    await patientProfile.waitForSelector('div:nth-child(2) > div > div > .A4 > div > div:nth-child(7) > div > div > b')
    await patientProfile.click('div:nth-child(2) > div > div > .A4 > div > div:nth-child(7) > div > div > b')
    await patientProfile.waitFor(500);
    await patientProfile.waitForSelector('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(1) > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.click('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(1) > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.evaluate(function() {
      document.querySelector('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(1) > div > #description > .v-tribute > .el-textarea__inner').value = ''
    })
    await patientProfile.type('div:nth-child(1) > .el-card > .el-card__body > div > div > div:nth-child(1) > div > #description > .v-tribute > .el-textarea__inner','test2134')
    await patientProfile.waitFor(500);
    ...
    await patientProfile.type('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner','test21345')
    await patientProfile.waitFor(500);
    await patientProfile.keyboard.press('Escape');
    await patientProfile.waitFor(500);
