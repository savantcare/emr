...
describe("Test Past Psych History for Addition", () => {
  ...
  //======================================== Add Past Psych History skill ===========================================
  test('Add Past Psych History skill', async () => {
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-past_psych_history div > div > #past_outpatient_treatment > .v-tribute > .el-textarea__inner','addPastOT');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-past_psych_history div > div > #past_meds_trials > .v-tribute > .el-textarea__inner','addPastMT');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-past_psych_history div > div > #hospitalization > .v-tribute > .el-textarea__inner','addHosp');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('div > div > #history_of_violence > .v-tribute > .el-textarea__inner','addHistVio');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-past_psych_history div > div > #history_of_self_harm > .v-tribute > .el-textarea__inner','addHistSelfHarm');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-past_psych_history div > div > #past_substance_abuse > .v-tribute > .el-textarea__inner','addPastSubAbuse');
