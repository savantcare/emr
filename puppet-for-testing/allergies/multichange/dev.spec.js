...
describe("Test Allergies for Addition", () => {
  ...
  //======================================== Multi Change Allergies skill ===========================================
  //-------------------------------------------- First Change -------------------------------------------------------
  test('Change Allergies skill', async () => {
    await ptProfilePage.waitForSelector('div:nth-child(3) > div > div > .A4 > div > div:nth-child(12) > div > div > b');
    await ptProfilePage.click('div:nth-child(3) > div > div > .A4 > div > div:nth-child(12) > div > div > b');
    await ptProfilePage.waitForTimeout(500);
    ...
    {
      // Allergen
      await ptProfilePage.waitForSelector('#pane-allergies .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner');
      await ptProfilePage.click('#pane-allergies .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner');
      
      await ptProfilePage.evaluate(function() {
        document.querySelector('#pane-allergies .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner').value = '';
      })
      await ptProfilePage.waitForTimeout(500);
      await ptProfilePage.type('#pane-allergies .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner','changeAllergen');

      // Reaction
      await ptProfilePage.waitForSelector('#pane-allergies .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner');
      await ptProfilePage.click('#pane-allergies .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner');
      
      await ptProfilePage.evaluate(function() {
        document.querySelector('#pane-allergies .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner').value = '';
      })
      await ptProfilePage.waitForTimeout(500);
      await ptProfilePage.type('#pane-allergies .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner','changeReaction');

      // Onset
      await ptProfilePage.waitForSelector('#pane-allergies .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner');
      await ptProfilePage.click('#pane-allergies .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner');
      
      await ptProfilePage.evaluate(function() {
        document.querySelector('#pane-allergies .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner').value = '';
      })
      await ptProfilePage.waitForTimeout(500);
      await ptProfilePage.type('#pane-allergies .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner','changeOnset');
    }
  }, timeout);

  //-------------------------------------------- Second Change -------------------------------------------------------
  test('Multi Change Allergies skill', async () => {
    if(isPresent == 'Yes')
    {
      // Allergen
      await ptProfilePage.waitForSelector('#pane-allergies div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner');
      await ptProfilePage.click('#pane-allergies div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner');
      
      await ptProfilePage.evaluate(function() {
        document.querySelector('#pane-allergies div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner').value = '';
      })
      await ptProfilePage.waitForTimeout(500);
      await ptProfilePage.type('#pane-allergies div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #allergen > .v-tribute > .el-input__inner','multiChangeAllergen');

      // Reaction
      await ptProfilePage.waitForSelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner');
      await ptProfilePage.click('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner');
      
      await ptProfilePage.evaluate(function() {
        document.querySelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner').value = '';
      })
      await ptProfilePage.waitForTimeout(500);
      await ptProfilePage.type('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #reaction > .v-tribute > .el-input__inner','multiChangeReaction');

      // Onset
      await ptProfilePage.waitForSelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner');
      await ptProfilePage.click('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner');
      
      await ptProfilePage.evaluate(function() {
        document.querySelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner').value = '';
      })
      await ptProfilePage.waitForTimeout(500);
      await ptProfilePage.type('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #onset > .v-tribute > .el-input__inner','multiChangeOnset');
    }
