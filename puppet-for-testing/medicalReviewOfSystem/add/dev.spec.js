...
describe("Test Medical Review Of System for Addition", () => {
  ...
  //======================================== Add Medical Review Of System skill ===========================================
  test('Add Medical Review Of System skill', async () => {
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medical_review_of_system div > div > #any_other_signs_symptoms > .v-tribute > .el-textarea__inner','addSign');
