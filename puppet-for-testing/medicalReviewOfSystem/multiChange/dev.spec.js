...
describe("Test Medical Review Of System for Addition", () => {
  ...
  //======================================== Multi Change Medical Review Of System skill =====================================
  test('Multi Change Medical Review Of System skill', async () => {
    ...
    await ptProfilePage.waitForSelector('#pane-medical_review_of_system #div-containing-one-button > #psychological_select1 > .el-button > span > span');
    await ptProfilePage.click('#pane-medical_review_of_system #div-containing-one-button > #psychological_select1 > .el-button > span > span');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medical_review_of_system div > div > #any_other_signs_symptoms > .v-tribute > .el-textarea__inner','multiChangeSign');
