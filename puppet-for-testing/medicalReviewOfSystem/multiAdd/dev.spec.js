...
describe("Test Medical Review Of System for Addition", () => {
  ...
  //======================================== Multi Add Medical Review Of System skill =====================================
  test('Multi Add Medical Review Of System skill', async () => {
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medical_review_of_system div > div > #any_other_signs_symptoms > .v-tribute > .el-textarea__inner','multiAddSign');
