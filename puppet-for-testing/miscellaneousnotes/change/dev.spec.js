...
describe("Test header and title of the page", () => {
  ...
  test('Single Edit miscellaneous notes skill', async () => {
    await patientProfile.waitForSelector('div:nth-child(2) > div > div > .A4 > div > div:nth-child(11) > div > div > b')
    await patientProfile.click('div:nth-child(2) > div > div > .A4 > div > div:nth-child(11) > div > div > b')
    await patientProfile.waitForTimeout(1000);

    await patientProfile.waitForSelector('#pane-miscellaneous_notes > .el-tabs:nth-child(1) > .el-tabs__content:nth-child(2) > #pane-change > div:nth-child(4) .el-card:nth-child(1) > .el-card__body:nth-child(1) #description > .v-tribute:nth-child(1) > .el-textarea__inner:nth-child(1)')
    await patientProfile.click('#pane-miscellaneous_notes > .el-tabs:nth-child(1) > .el-tabs__content:nth-child(2) > #pane-change > div:nth-child(4) .el-card:nth-child(1) > .el-card__body:nth-child(1) #description > .v-tribute:nth-child(1) > .el-textarea__inner:nth-child(1)')
    await patientProfile.evaluate(function() {
        document.querySelector('#pane-miscellaneous_notes > .el-tabs:nth-child(1) > .el-tabs__content:nth-child(2) > #pane-change > div:nth-child(4) .el-card:nth-child(1) > .el-card__body:nth-child(1) #description > .v-tribute:nth-child(1) > .el-textarea__inner:nth-child(1)').value = ''
    })
    await patientProfile.type('#pane-miscellaneous_notes > .el-tabs:nth-child(1) > .el-tabs__content:nth-child(2) > #pane-change > div:nth-child(4) .el-card:nth-child(1) > .el-card__body:nth-child(1) #description > .v-tribute:nth-child(1) > .el-textarea__inner:nth-child(1)','test2')
    await patientProfile.waitForTimeout(500);
