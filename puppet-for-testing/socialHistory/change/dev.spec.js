...
describe("Test Social History for Change", () => {
  ...
  //======================================== Change Social History skill ===========================================
  test('Change Social History skill', async () => {
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-social_history div > div > #current_social_situation > .v-tribute > .el-textarea__inner','changeCurSS');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-social_history div > div > #education_work_history > .v-tribute > .el-textarea__inner','changeEduWM');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-social_history div > div > #social_supports > .v-tribute > .el-textarea__inner','changeSocSup');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-social_history div > div > #developmental_history > .v-tribute > .el-textarea__inner','changeDevHis');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-social_history div > div > #trauma_history > .v-tribute > .el-textarea__inner','changeTraHis');
