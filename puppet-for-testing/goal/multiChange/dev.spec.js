...
describe("Test Goal for Addition", () => {
  ...
  //======================================== Multi Add Goal skill ===========================================
  test('Multi Add Goal skill', async () => {
    ...
    //Second Add
    await ptProfilePage.waitForSelector('#pane-goals div:nth-child(2) > div > div > #description > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-goals div:nth-child(2) > div > div > #description > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-goals div:nth-child(2) > div > div > #description > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-goals div:nth-child(2) > div > div > #description > .v-tribute > .el-textarea__inner','multiAddGoal');

    //Slider
    await ptProfilePage.waitForSelector('#pane-goals div:nth-child(2) > div > div > div > .block > .el-slider > .el-slider__runway > .el-slider__stop:nth-child(6)');
    await ptProfilePage.click('#pane-goals div:nth-child(2) > div > div > div > .block > .el-slider > .el-slider__runway > .el-slider__stop:nth-child(6)');
  ...
  test('Change Goal skill', async () => {
    ...
    // Second Change
    await ptProfilePage.waitForSelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner');
    ...
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner','multiChangeGoal');

    //Slider
    await ptProfilePage.waitForSelector('#pane-goals div:nth-child(2) > .el-card:nth-child(1) > .el-card__body:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) .block:nth-child(1) > .el-slider:nth-child(1) > .el-slider__runway:nth-child(1) > .el-slider__bar:nth-child(1)');
    await ptProfilePage.click('#pane-goals div:nth-child(2) > .el-card:nth-child(1) > .el-card__body:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) .block:nth-child(1) > .el-slider:nth-child(1) > .el-slider__runway:nth-child(1) > .el-slider__bar:nth-child(1)');
