...
describe("Test header and title of the page", () => {
  ...
  test('Delete family history', async () => {
    ...
    await patientProfile.waitForSelector('.el-message-box__wrapper > .el-message-box > .el-message-box__btns > .el-button:nth-child(1) > span')
    await patientProfile.click('.el-message-box__wrapper > .el-message-box > .el-message-box__btns > .el-button:nth-child(1) > span')
