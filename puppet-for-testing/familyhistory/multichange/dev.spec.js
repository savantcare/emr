...
describe("Test header and title of the page", () => {
  ...
  test('multi add family history', async () => {
    ...
    await patientProfile.waitForSelector('#each-data-row-1-family_history > div > div > #relationship > .v-tribute > .el-input__inner')
    await patientProfile.click('#each-data-row-1-family_history > div > div > #relationship > .v-tribute > .el-input__inner')
    await patientProfile.type('#each-data-row-1-family_history > div > div > #relationship > .v-tribute > .el-input__inner','test3')
    await patientProfile.waitForTimeout(500);

    await patientProfile.waitForSelector('#each-data-row-1-family_history > div > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.click('#each-data-row-1-family_history > div > div > #description > .v-tribute > .el-textarea__inner')
    await patientProfile.type('#each-data-row-1-family_history > div > div > #description > .v-tribute > .el-textarea__inner','test3')
  ...
  test('Multi change family history', async () => {
    ...
    await patientProfile.waitForSelector('div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner')
    await patientProfile.click('div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner')

    await patientProfile.evaluate(function() {
        document.querySelector('div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner').value = ''
    })
    await patientProfile.type('div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner','test12')
    ...
    await patientProfile.type('div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner','test123')
    await patientProfile.waitForTimeout(500);

    await patientProfile.waitForSelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner')
    await patientProfile.click('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner')

    await patientProfile.evaluate(function() {
        document.querySelector('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner').value = ''
    })
    await patientProfile.type('div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #relationship > .v-tribute > .el-input__inner','test1234')
    await patientProfile.waitForTimeout(500);
  ...
  test('Multi delete family history', async () => {
    await patientProfile.waitForSelector('div:nth-child(3) > div > div > .A4 > div > div:nth-child(8) > div > div > b')
    await patientProfile.click('div:nth-child(3) > div > div > .A4 > div > div:nth-child(8) > div > div > b')
    await patientProfile.waitForTimeout(500);
    ...
    deleteMultiple = await patientProfile.waitForSelector('.el-popup-parent--hidden > .el-message > .el-message__content')
    await expect(deleteMultiple).toMatch('family history deleted.')
  }, timeout);
