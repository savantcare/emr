...
describe("Test Medication Orders for Addition", () => {
  ...
  //======================================== Multi Add Medication Orders skill ===========================================
  //-------------------------------------------- First Addition -------------------------------------------------------
  ...
  //-------------------------------------------- Second Addition -------------------------------------------------------
  test('Multi Add Medication Orders skill', async () => {
    // Drug name
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #drugName > .v-tribute > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #drugName > .v-tribute > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #drugName > .v-tribute > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #drugName > .v-tribute > .el-input__inner','mDrug');

    // Direction for the patient
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner','maddPtDir');

    // Start date
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > div > .el-date-editor:nth-child(2) > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > div > .el-date-editor:nth-child(2) > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > div > .el-date-editor:nth-child(2) > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > div > .el-date-editor:nth-child(2) > .el-input__inner','23/04/2021');

    // Quantity
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #qty > .valid-dirty-data > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #qty > .valid-dirty-data > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #qty > .valid-dirty-data > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #qty > .valid-dirty-data > .el-input__inner','5');

    // Days supply
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #daysSupply > .el-input > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #daysSupply > .el-input > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #daysSupply > .el-input > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #daysSupply > .el-input > .el-input__inner','2');

    //Number of refill
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #numberOfRefill > .el-input > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #numberOfRefill > .el-input > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #numberOfRefill > .el-input > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #numberOfRefill > .el-input > .el-input__inner','5');

    //Dispense as written
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #dispenseAsWritten > .el-input > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #dispenseAsWritten > .el-input > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #dispenseAsWritten > .el-input > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #dispenseAsWritten > .el-input > .el-input__inner','mDispense');

    //Notes to pharmacist
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner','mPharmacist');

    //Ordering provider
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #orderingProvider > .v-tribute > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #orderingProvider > .v-tribute > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #orderingProvider > .v-tribute > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #orderingProvider > .v-tribute > .el-input__inner','mOrdering');

    //Pharmacy
    await ptProfilePage.waitForSelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #pharmacy > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #pharmacy > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #pharmacy > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders #each-data-row-1-medication_orders > div > div > #pharmacy > .v-tribute > .el-textarea__inner','mPharmacy');
  ...
  //======================================== Multi Change Medication Orders skill ===========================================
  //-------------------------------------------- First Change -------------------------------------------------------
  ...
  //-------------------------------------------- Second Change -------------------------------------------------------
  test('Multi Change Medication Orders skill', async () => {
    // Drug name
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #drugName > .v-tribute > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #drugName > .v-tribute > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #drugName > .v-tribute > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #drugName > .v-tribute > .el-input__inner','changeDrug');

    // Direction for the patient
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #directionsForPatient > .v-tribute > .el-textarea__inner','changePtDir');

    // Start date
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > .el-date-editor > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > .el-date-editor > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > .el-date-editor > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > .el-date-editor > .el-input__inner','24/04/2021');

    // Quantity
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #qty > .el-input > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #qty > .el-input > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #qty > .el-input > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #qty > .el-input > .el-input__inner','7');

    // Days supply
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #daysSupply > .el-input > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #daysSupply > .el-input > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #daysSupply > .el-input > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #daysSupply > .el-input > .el-input__inner','5');

    //Number of refill
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #numberOfRefill > .el-input > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #numberOfRefill > .el-input > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #numberOfRefill > .el-input > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(1) > .el-card > .el-card__body > div > div > div > div > #numberOfRefill > .el-input > .el-input__inner','7');

    //Dispense as written
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #dispenseAsWritten > .el-input > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #dispenseAsWritten > .el-input > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #dispenseAsWritten > .el-input > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #dispenseAsWritten > .el-input > .el-input__inner','ChangeDispense');

    //Notes to pharmacist
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #notesToPharmacist > .v-tribute > .el-textarea__inner','ChangePharmacist');

    //Ordering provider
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #orderingProvider > .v-tribute > .el-input__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #orderingProvider > .v-tribute > .el-input__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #orderingProvider > .v-tribute > .el-input__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #orderingProvider > .v-tribute > .el-input__inner','ChangeOrdering');

    //Pharmacy
    await ptProfilePage.waitForSelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #pharmacy > .v-tribute > .el-textarea__inner');
    await ptProfilePage.click('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #pharmacy > .v-tribute > .el-textarea__inner');
    
    await ptProfilePage.evaluate(function() {
      document.querySelector('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #pharmacy > .v-tribute > .el-textarea__inner').value = '';
    })
    await ptProfilePage.waitForTimeout(500);
    await ptProfilePage.type('#pane-medication_orders div:nth-child(2) > .el-card > .el-card__body > div > div > div > div > #pharmacy > .v-tribute > .el-textarea__inner','ChangePharmacy');
