...
describe("Test header and title of the page", () => {
  ...
  test('Single Edit process notes skill', async () => {
    await patientProfile.waitForSelector('div:nth-child(2) > div > div > .A4 > div > div:nth-child(12) > div > div > b')
    await patientProfile.click('div:nth-child(2) > div > div > .A4 > div > div:nth-child(12) > div > div > b')
    await patientProfile.waitForTimeout(1000);
    ...
    await patientProfile.type('.el-card__body > div > div > div > div > #description > .v-tribute > .el-textarea__inner','test2')
    await patientProfile.waitForTimeout(500);
  ...
  test('Delete process notes', async () => {
    await patientProfile.waitForSelector('div:nth-child(2) > div > div > .A4 > div > div:nth-child(12) > div > div > b')
    await patientProfile.click('div:nth-child(2) > div > div > .A4 > div > div:nth-child(12) > div > div > b')
    
    await patientProfile.waitForSelector('#pane-process_notes > .el-tabs:nth-child(1) > .el-tabs__content:nth-child(2) > #pane-change > div:nth-child(4) > div:nth-child(1) > .el-card:nth-child(1) > .el-card__body:nth-child(1) .el-button:nth-child(1) > span:nth-child(1)')
    await patientProfile.click('#pane-process_notes > .el-tabs:nth-child(1) > .el-tabs__content:nth-child(2) > #pane-change > div:nth-child(4) > div:nth-child(1) > .el-card:nth-child(1) > .el-card__body:nth-child(1) .el-button:nth-child(1) > span:nth-child(1)')
