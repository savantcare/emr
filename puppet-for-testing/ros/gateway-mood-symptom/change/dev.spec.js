...
describe("Test header and title of the page", () => {
  ...
  test('single change gate way mood symptom', async () => {
    await page.waitForTimeout(1000);
    ...
    await patientProfile.waitForSelector('.el-tabs__header #tab-gateway_mood_symptoms')
    await patientProfile.click('.el-tabs__header #tab-gateway_mood_symptoms')
    await patientProfile.waitForTimeout(500);
  ...
  test('Save gate way mood symptom', async () => {
    await patientProfile.waitForTimeout(500);
  ...
  test('Clear gate way mood symptom', async () => {
    await page.waitForTimeout(1000);
  ...
  test('Save clear gate way mood symptom', async () => {
    await patientProfile.waitForTimeout(500);
