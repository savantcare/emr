...
class WeightController extends Controller
{
    ...
    /*
    To check weight/create in postman make a post pRequest with the following JSON:
    Open postman desktop app and then:
    URL: http://localhost:8000/public/api/weight/v20/
    Post / Body raw: {"rowToUpsert":{"$serverSideRowUuid":"3","vnRowStateInSession":34,"validationClass":"","isValidationError":false,"clientSideUniqRowId":3,"serverSideRowUuid":"01817fb0-c1ef-11ea-a3a5-f36fe4d74da4","weightInPounds":100,"timeOfMeasurementInMilliseconds":1601876131994,"notes":"test","recordChangedByUuid":"bfe041fa-073b-4223-8c69-0540ee678ff8","recordChangedFromIPAddress":"::1","recordChangedFromSection":"null","ROW_START":1601877241687,"ROW_END":2147483648000}}
    */
    ...
    public function create(Request $pRequest)
    {
        ...
        $insertTempereture = DB::statement("INSERT INTO `sc_vital_signs`.`weight` (`serverSideRowUuid`, `ptUuid`, `weightInPounds`, `timeOfMeasurementInMilliseconds`, `notes`, `recordChangedByUuid`, `recordChangedFromIPAddress`) VALUES ('{$serverSideRowUuid}', '{$ptUuid}', {$weightInPounds}, FROM_UNIXTIME({$timeOfMeasurementInMilliseconds}/1000), '{$notes}', '{$recordChangedByUuid}', '{$recordChangedFromIPAddress}')");

        return response()->json($insertTempereture, 201);
    }

    /*
    To check weight/update in postman make a put pRequest with the following JSON:
    Open postman desktop app and then:
    URL: http://localhost:8000/public/api/weight/v20/
    Put / Body JSON: {"rowToUpsert":{"$serverSideRowUuid":"3","vnRowStateInSession":34,"validationClass":"","isValidationError":false,"clientSideUniqRowId":3,"serverSideRowUuid":"01817fb0-c1ef-11ea-a3a5-f36fe4d74da4","weightInPounds":100,"timeOfMeasurementInMilliseconds":1601876131994,"notes":"test","recordChangedByUuid":"bfe041fa-073b-4223-8c69-0540ee678ff8","recordChangedFromIPAddress":"::1","recordChangedFromSection":"null","ROW_START":1601877241687,"ROW_END":2147483648000}}
    */



    public function update($serverSideRowUuid, Request $pRequest)
    {
        $requestData = $pRequest->all();
