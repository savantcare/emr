...
import heightSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/height/search-phrases'
import weightSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/weight/search-phrases'
import pulseSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/pulse/search-phrases'
import temperatureSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/temperature/search-phrases'
import bloodPressureSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/blood-pressure/search-phrases'
import bloodSugarSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/blood-sugar/search-phrases'
import waistCircumferenceSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/waist-circumference/search-phrases'
import oxygenSaturationSPhrases from '@/cts/spi/1t-1rMf/bm/sub-cts/oxygen-saturation/search-phrases'
