...
export default class ormSearchPhrasesOfCt extends Model {
  ...
  static fields() {
    return {
      ...
      scope: this.string('table'), // scope can either be table or row. Row scope serach terms do not come in Vl or Cl search box. Row scope search terms are only used to invokle Ct when a icon is click in Vl
    }
  }
}
