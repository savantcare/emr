...
export default class ormSearchPhrasesOfCt extends Model {
  ...
  static fields() {
    return {
      ...
      location: this.string(''), // This can have the value of "ptsvl" or "cl". It is used to decide where to show the ct.
      usageCountKeptInOrm: this.number(0), // usageCountKeptInOrm => usage Count Kept In Orm. This is used to order the search results.
