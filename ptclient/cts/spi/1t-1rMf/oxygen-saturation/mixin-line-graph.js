  ...
  computed: {
    chartOptions() {
      ...
      const chartOptions = {
        ...
        title: {
          text: '',
        }, // Reason: Y axis will have orm.entity for e.g. "oxygenSaturation" written beside it. This is small space. Difficult design decisions need to be made instead of doing everything.
        xAxis: [
          {
            title: {
