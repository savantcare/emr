...
Code synced with ref implementation on 11th sept 2020
<template>
  <div>
    <el-form>
...
export default {
  ...
  computed: {
    ...
    cfGetScrsMasterData() {
      ...
      // get the screen master list which is not used by the patient
  ...
  async mounted() {
    /* Q) Why we are fetching data locally instead of using orm  
        ...
        Ans) The screen master data 'arScrMaster' is used only for add screenign section
        and the this is master data there is no historical data 
        due to this we fetched the data direct form api to this template.
      */
