...
cp /gt/sc-prog-repos/emr/ptclient/cts/spi/1t-Mr1f/rem/db/sequalize/reminder.model.js /gt/sc-prog-repos/emr/ptserver/models/
...
# cp /gt/sc-prog-repos/emr/ptclient/cts/spi/1t-Mr1f/rem/db/sequalize/reminder.route.js /gt/sc-prog-repos/emr/ptserver/routes/