...
import CtSearch from '~/components/core/search-phrases/db/client-side-db/search-phrases-of-components-table'
import CtLifeCycle from '~/components/core/ctMaster/orm-ct-life-cycle'
import Rem from '~/components/pt-info/single/1t-Mrow-1Field/rem/db/client-side-db/rem-table.js'
...
import Rec from '~/components/pt-info/single/1t-Mrow-1Field/rec/db/client-side-db/model.js'
import Dx from '~/components/pt-info/single/1t-Mrow-mField/dx/db/client-side-db/Dx.js'
import Goal from '~/components/pt-info/single/1t-Mrow-mField/goal/db/client-side-db/Goal'
import Scr from '~/components/pt-info/single/1t-Mrow-mField/scr/db/client-side-db/Screening'
import Dxa from '~/components/pt-info/single/1t-Mrow-mField/dx/db/client-side-db/Dxa.js'
import phoneNumbers from '~/components/pt-info/single/1t-Mrow-mField/phone-numbers/db/client-side-db/table.js'
