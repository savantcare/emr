  ...
  var TributeSearch = /*#__PURE__*/function () {
    ...
    _createClass(TributeSearch, [{
      ...
      value: function match(pattern, string, opts) {
        ...
        return {
          rendered: this.render(string, patternCache.cache, pre, post, pattern),
      ...
      value: function traverse(string, pattern, stringIndex, patternIndex, patternCache) {
        ...
        var rgxp = new RegExp(pattern, "g")
        var patternLength = (string.match(rgxp) || []).length

        if (patternLength === patternIndex && patternLength > 0) {
        ...
        //if (string.length === stringIndex || patternLength - patternIndex > string.length - stringIndex) {
        //  return undefined;
        //}
        
        if (string.length === stringIndex || patternIndex > patternLength) {
          return undefined;
        }
      ...
      key: "render",
      value: function render(string, indices, pre, post, pattern) {
        ...
        */
        ...
        var search_regexp = new RegExp(pattern, "gi");
        return search_regexp, string.replace(search_regexp, pre + pattern + post)
      }
    }, {
      key: "filter",
