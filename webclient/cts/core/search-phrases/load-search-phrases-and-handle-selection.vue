...
import mapSPhrases from '@/cts/core/map/search-phrases-ct'
import clearSPhrases from '@/cts/core/clear/search-phrases-ct'
import nameSPhrases from '@/cts/pt-info/single/1t-1row-mField/name/search-phrases-ct'
import heightSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/height/search-phrases-ct'
import weightSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/weight/search-phrases-ct'
import pulseSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/pulse/search-phrases-ct'
import temperatureSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/temperature/search-phrases-ct'
import bloodPressureSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/blood-pressure/search-phrases-ct'
import bloodSugarSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/blood-sugar/search-phrases-ct'
import waistCircumferenceSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/waist-circumference/search-phrases-ct'
import oxygenSaturationSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/oxygen-saturation/search-phrases-ct'
import phq9SPhrases from '@/cts/pt-info/single/1t-1row-mField/phq9/search-phrases-ct'
import bmSPhrases from '@/cts/pt-info/single/1t-1row-mField/bm/search-phrases-ct'
import dobSPhrases from '@/cts/pt-info/single/1t-1row-mField/date-of-birth/search-phrases-ct'
import remSPhrases from '@/cts/pt-info/single/1t-Mrow-1Field/rem/search-phrases-ct'
import ssSPhrases from '@/cts/pt-info/single/1t-Mrow-1Field/ss/search-phrases-ct'
import phoneNumberSPhrases from '@/cts/pt-info/single/1t-Mrow-mField/phone-numbers/search-phrases-ct'
