...
import nameSPhrases from '@/cts/spi/1t-1row-mField/name/search-phrases-ct'
import heightSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/height/search-phrases-ct'
import weightSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/weight/search-phrases-ct'
import pulseSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/pulse/search-phrases-ct'
import temperatureSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/temperature/search-phrases-ct'
import bloodPressureSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/blood-pressure/search-phrases-ct'
import bloodSugarSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/blood-sugar/search-phrases-ct'
import waistCircumferenceSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/waist-circumference/search-phrases-ct'
import oxygenSaturationSPhrases from '@/cts/spi/1t-1row-mField/bm/sub-cts/oxygen-saturation/search-phrases-ct'
import phq9SPhrases from '@/cts/spi/1t-1row-mField/phq9/search-phrases-ct'
