...
cp /gt/sc-prog-repos/emr/webclient/cts/spi/1t-Mrow-1Field/rem/db/sequalize/phoneNumber.model.js /gt/sc-prog-repos/emr/ptserver/models/
...
# cp /gt/sc-prog-repos/emr/webclient/cts/spi/1t-Mrow-1Field/rem/db/sequalize/phoneNumber.route.js /gt/sc-prog-repos/emr/ptserver/routes/