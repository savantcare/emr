...
<script>
import ctWeight from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/weight/vl/table-ct.vue'
import ctHeight from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/height/vl/table-ct.vue'
import ctTemperature from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/temperature/vl/table-ct.vue'
import ctBloodPressure from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/blood-pressure/vl/table-ct.vue'
import ctBloodSugar from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/blood-sugar/vl/table-ct.vue'
import ctWaistCircumference from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/waist-circumference/vl/table-ct.vue'
import ctPulse from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/pulse/vl/table-ct.vue'
import ctOxygenSaturation from '@/cts/pt-info/single/1t-1row-mField/bm/sub-cts/oxygen-saturation/vl/table-ct.vue'
export default {
  components: {
    ctWeight,
    ctHeight,
