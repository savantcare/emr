  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'rem',
        ctToShow: '1time-eachField-multiValues/recommendations/view-layer/timeline-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'arem',
        ctToShow: '1time-eachField-multiValues/recommendations/edit-layer/add-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'crem',
        ctToShow: '1time-eachField-multiValues/recommendations/edit-layer/edit-design-1.vue',
        displayLocation: 'edit-layer',
        ctWidthInEditLayer: 'small',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'mcrem',
        ctToShow: '1time-eachField-multiValues/recommendations/edit-layer/medit-design-1.vue',
        displayLocation: 'edit-layer',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'drem',
        ctToShow: '1time-eachField-multiValues/recommendations/view-layer/deleted.vue',
        displayLocation: 'edit-layer',
        ctWidthInEditLayer: 'large',
      },
    })
