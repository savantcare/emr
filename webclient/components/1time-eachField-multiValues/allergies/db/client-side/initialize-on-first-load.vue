...
<script>
import initializeReminderComponent from '@/components/1time-eachField-multiValues/allergies/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
