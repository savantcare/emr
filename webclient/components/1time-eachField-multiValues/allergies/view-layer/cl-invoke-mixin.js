...
import clientSideTable from '~/components/1time-eachField-multiValues/allergies/db/client-side/structure/allergies-of-a-patient-table.js'
...
export default {
  methods: {
    ...
    mxOpenDDialog() {
      let confirmMessage = 'Are you sure you want to delete all the selected allergies?'
    ...
    mxOpenEditCtInEditLayer(pClientSideDataRowId) {
      ...
      */
      const payload = { searchTerm: 'edit allergy', pPropsToGiveToCt: pClientSideDataRowId }
