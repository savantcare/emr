...
<script>
import clientSideTable from '../db/client-side/structure/allergies-of-a-patient-table.js'
      ...
      */
      ...
      if (arFromClientSideTable.length) {
        ...
        for (let i = startDataRowInidex; i < arFromClientSideTable.length && i < endDataRowIndex; i++) {
          ...
          // For date format ref: /cts/1time-eachField-multiValues/allergies/view-layer/timeline-ct.vue:53
