...
<script>
import initializeRecommendationComponent from '@/components/1time-eachField-multiValues/process-notes/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientSideTable from '~/components/1time-eachField-multiValues/process-notes/db/client-side/structure/process-notes-of-a-patient-table.js'
