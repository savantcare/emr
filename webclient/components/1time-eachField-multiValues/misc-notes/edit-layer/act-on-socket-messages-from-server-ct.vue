...
import clientTbl from '../db/client-side/structure/misc-notes-of-a-patient-table.js'

export default {
  mounted() {
    console.log('mounted act-on-socket-messages-from-server-ct for misc-notes')
