...
<script>
import initializeReminderComponent from '@/components/1time-eachField-multiValues/reminders/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientSideTable from '~/components/1time-eachField-multiValues/reminders/db/client-side/structure/reminders-of-a-patient-table.js'
