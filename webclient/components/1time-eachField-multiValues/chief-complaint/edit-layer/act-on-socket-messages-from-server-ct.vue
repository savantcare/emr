...
import clientTbl from '../db/client-side/structure/chief-complaint-of-a-patient-table.js'

export default {
  mounted() {
    console.log('mounted act-on-socket-messages-from-server-ct for chief-complaint')
