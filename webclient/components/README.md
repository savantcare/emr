...
1. The entrance file is: [search-phrases-ct.vue](https://github.com/savantcare/emr/blob/master/webclient/cts/1time-Mrow-1Field/reminder/search-phrases-ct.vue)
