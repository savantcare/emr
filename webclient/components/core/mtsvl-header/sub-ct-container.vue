...
import ctName from '@/components/pt-info/single/1t-1row-mField/name/view-layer/privacy-protected-name.vue'
import ctAge from '@/components/pt-info/single/1t-1row-mField/date-of-birth/view-layer/age.vue'
