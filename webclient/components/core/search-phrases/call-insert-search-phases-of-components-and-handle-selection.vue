<template>
  <div id="manage-ptsvl-cards">
    ...
    <insertDiagnosisComponentSearchPhrases />
...
import insertDiagnosisComponentSearchPhrases from '@/components/pt-info/single/1time-Mrow-mField/diagnosis/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
