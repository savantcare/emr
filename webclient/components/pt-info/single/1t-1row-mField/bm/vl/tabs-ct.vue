...
<script>
import ctWeightGraph from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/weight/vl/line-graph-ct.vue'
import ctHeightGraph from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/height/vl/line-graph-ct.vue'
