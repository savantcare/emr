...
<script>
import ctWeight from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/weight/vl/table-ct.vue'
import ctHeight from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/height/vl/table-ct.vue'
import ctTemperature from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/temperature/vl/table-ct.vue'
import ctBloodPressure from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/blood-pressure/vl/table-ct.vue'
import ctBloodSugar from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/blood-sugar/vl/table-ct.vue'
import ctWaistCircumference from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/waist-circumference/vl/table-ct.vue'
import ctPulse from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/pulse/vl/table-ct.vue'
import ctOxygenSaturation from '@/components/pt-info/single/1t-1row-mField/bm/sub-cts/oxygen-saturation/vl/table-ct.vue'
export default {
  components: {
    ctWeight,
    ctHeight,
