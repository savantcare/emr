  ...
  mounted() {
    tblSearchPhrasesOfCt.insert({
      data: {
        value: 'pulse',
        ctAbbr: 'w',
        ctToShow: 'pt-info/single/1t-1row-mField/bm/sub-cts/pulse/view-layer/line-graph-ct.vue',
    ...
    tblSearchPhrasesOfCt.insert({
      data: {
        value: 'pulse - change',
        ctAbbr: 'wc',
        ctToShow: 'pt-info/single/1t-1row-mField/bm/sub-cts/pulse/change-layer/c-ct.vue', // Cl -> Change layer
        displayLocation: 'cl',
        needsRowIdToWork: 'no',
      },
    })
