  ...
  mounted() {
    tblSearchPhrasesOfCt.insert({
      data: {
        ...
        ctAbbr: 'bm',
        ctToShow: 'pt-info/single/1t-1row-mField/bm/view-layer/tabs-ct.vue', // PtsVl -> Present time state - part of - view layer
    ...
    tblSearchPhrasesOfCt.insert({
      data: {
        ...
        ctAbbr: 'bmcc',
        ctToShow: 'pt-info/single/1t-1row-mField/bm/change-layer/c-ct.vue', // Cl -> Change layer
        displayLocation: 'cl',
        needsRowIdToWork: 'no',
      },
    })
