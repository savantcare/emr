...
import mxTable from '@/components/pt-info/single/1t-1row-mField/com-mx/mixins/view-layer.js'
...
export default {
  ...
  props: {
    ...
    date: {
      ctName: 'name', // this is supposed to be used by import mxTable from '@/components/pt-info/single/1t-1row-mField/com-mx/mixins/view-layer.js so that the same mixin cab be used by name height and weight
    },
  },
}
</script>
