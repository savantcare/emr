...
ct Code synced with ref implementation on 18th sept 2020
<template>
  <div>
...
<script>
import mxScrMasterData from '../static-data/scr-master-data'
import mxFullSyncWithDbServer from '../db/full-sync-with-server-db-mixin'
import objOrm from '../db/vuex-orm/scr-table.js'
