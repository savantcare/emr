// Master doc is at reference implementation name/change-layer/c-ct.vue. This file has doc unique to
...
<template>
  <div>
    <el-form>
      ...
      <el-form-item>
        <el-button :disabled="cfHasSomeFldChanged" type="success" plain @click="mfOnSubmit">Submit</el-button>
        <el-button
