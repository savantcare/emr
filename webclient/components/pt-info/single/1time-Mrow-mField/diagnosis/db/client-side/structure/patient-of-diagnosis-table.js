...
import masterOfDiagnosisTable from './master-of-diagnosis-table'
const { v1: uuidv1 } = require('uuid')

let count = 0
const intUniqueID = () => ++count

export default class patientOfDiagnosiTable extends clientSideTableManage {
