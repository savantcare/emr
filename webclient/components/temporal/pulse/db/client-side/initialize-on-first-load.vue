...
<script>
import initializeRecommendationComponent from '@/components/temporal/pulse/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/pulse/db/client-side/structure/pulse-of-a-patient-table.js'
