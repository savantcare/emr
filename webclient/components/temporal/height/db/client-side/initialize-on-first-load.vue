...
<script>
import initializeRecommendationComponent from '@/components/temporal/height/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/height/db/client-side/structure/height-of-a-patient-table.js'
