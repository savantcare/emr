...
<script>
import initializeRecommendationComponent from '@/components/temporal/recommendations/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/recommendations/db/client-side/structure/recommendations-of-a-patient-table.js'
