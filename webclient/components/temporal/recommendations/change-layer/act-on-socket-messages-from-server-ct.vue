...
import clientTbl from '../db/client-side/structure/recommendations-of-a-patient-table.js'

export default {
  mounted() {
    console.log('mounted act-on-socket-messages-from-server-ct for recommendations')
  ...
  sockets: {
    async MsgFromSktForRemToAdd(pData) {
      ...
      */
        const clientSidePrimaryKeyValue = arFromClientTbl.tblRecommendations[0].clientSideUniqRowId
        setTimeout(
          function (scope) {
