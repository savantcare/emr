  ...
  mounted() {
    clientTblOfCtSearchPhrases.insert({
      data: {
        value: 'blood Sugar',
        ctAbbr: 'bs',
        ctToShow: 'temporal/vital-signs/sub-cts/blood-sugar-levels/view-layer/line-graph-ct.vue',
    ...
    clientTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'bsc',
        ctToShow: 'temporal/vital-signs/sub-cts/blood-sugar-levels/change-layer/edit-design-1.vue', // El -> Edit layer
