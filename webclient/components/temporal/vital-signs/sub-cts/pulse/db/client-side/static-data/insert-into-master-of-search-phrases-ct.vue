  ...
  mounted() {
    clientTblOfCtSearchPhrases.insert({
      data: {
        value: 'pulse',
        ctAbbr: 'w',
        ctToShow: 'temporal/vital-signs/sub-cts/pulse/view-layer/line-graph-ct.vue',
    ...
    clientTblOfCtSearchPhrases.insert({
      data: {
        value: 'pulse - edit',
        ctAbbr: 'wc',
        ctToShow: 'temporal/vital-signs/sub-cts/pulse/change-layer/edit-design-1.vue', // El -> Edit layer
