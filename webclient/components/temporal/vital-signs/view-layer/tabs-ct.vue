...
import ctWaistCircumferenceGraph from '@/components/temporal/vital-signs/sub-cts/waist-circumference/view-layer/line-graph-ct.vue'
import ctPulseGraph from '@/components/temporal/vital-signs/sub-cts/pulse/view-layer/line-graph-ct.vue'
import ctOxygenSaturationGraph from '@/components/temporal/vital-signs/sub-cts/oxygen-saturation/view-layer/line-graph-ct.vue'
export default {
  components: {
    ctWeightGraph,
    ctHeightGraph,
