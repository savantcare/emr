...
<script>
import initializeRecommendationComponent from '@/components/temporal/temperature/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/temperature/db/client-side/structure/temperature-of-a-patient-table.js'
