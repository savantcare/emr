...
<script>
import initializeRecommendationComponent from '@/components/temporal/process-notes/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/process-notes/db/client-side/structure/process-notes-of-a-patient-table.js'
