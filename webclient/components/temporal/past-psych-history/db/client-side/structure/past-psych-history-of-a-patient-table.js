...
export const pastPsychHistoryFormDef = {
  ...
  fieldsDef: [
    ...
    { fieldNameInDb: 'past_meds_trials', fieldNameInUi: 'Past meds trials', fieldType: 'textarea', span: 12 },
    { fieldNameInDb: 'hospitalization', fieldNameInUi: 'Hospitalization', fieldType: 'textarea', span: 12 },
    { fieldNameInDb: 'history_of_violence', fieldNameInUi: 'History of violence', fieldType: 'textarea', span: 12 },
