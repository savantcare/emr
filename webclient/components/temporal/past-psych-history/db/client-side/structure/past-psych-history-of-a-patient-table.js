...
export const pastPsychHistoryFormDef = {
  ...
  fieldsDef: [
    ...
    { fieldNameInDb: 'past_meds_trials', fieldNameInUi: 'past_meds_trials', fieldType: 'textarea', span: 12 },
    { fieldNameInDb: 'hospitalization', fieldNameInUi: 'hospitalization', fieldType: 'textarea', span: 12 },
    { fieldNameInDb: 'history_of_violence', fieldNameInUi: 'history_of_violence', fieldType: 'textarea', span: 12 },
    { fieldNameInDb: 'history_of_self_harm', fieldNameInUi: 'history_of_self_harm', fieldType: 'textarea', span: 12 },
    { fieldNameInDb: 'past_substance_abuse', fieldNameInUi: 'past_substance_abuse', fieldType: 'textarea', span: 12 },
  ],
