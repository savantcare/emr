...
<script>
import initializeRecommendationComponent from '@/components/temporal/blood-pressure/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/blood-pressure/db/client-side/structure/blood-pressure-of-a-patient-table.js'
