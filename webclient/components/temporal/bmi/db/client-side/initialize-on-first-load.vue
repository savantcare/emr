...
<script>
import initializeRecommendationComponent from '@/components/temporal/bmi/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/bmi/db/client-side/structure/bmi-of-a-patient-table.js'
