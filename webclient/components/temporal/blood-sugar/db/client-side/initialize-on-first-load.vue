...
<script>
import initializeRecommendationComponent from '@/components/temporal/blood-sugar/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/temporal/blood-sugar/db/client-side/structure/blood-sugar-of-a-patient-table.js'
