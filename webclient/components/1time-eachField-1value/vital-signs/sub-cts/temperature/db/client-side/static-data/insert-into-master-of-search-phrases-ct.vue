  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'temperature',
        ctAbbr: 'w',
        ctToShow: '1time-eachField-1value/vital-signs/sub-cts/temperature/view-layer/table-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'wc',
        ctToShow: '1time-eachField-1value/vital-signs/sub-cts/temperature/edit-layer/edit-design-1.vue', // El -> Edit layer
