  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'height',
        ctAbbr: 'h',
        ctToShow: '1time-eachField-1value/vital-signs/sub-cts/height/view-layer/line-graph-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'height - edit',
        ctAbbr: 'hc',
        ctToShow: '1time-eachField-1value/vital-signs/sub-cts/height/edit-layer/edit-design-1.vue', // El -> Edit layer
