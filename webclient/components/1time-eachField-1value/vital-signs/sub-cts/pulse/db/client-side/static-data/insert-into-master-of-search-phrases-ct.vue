  ...
  mounted() {
    clientTblOfCtSearchPhrases.insert({
      data: {
        value: 'pulse',
        ctAbbr: 'w',
        ctToShow: '1time-eachField-1value/vital-signs/sub-cts/pulse/view-layer/line-graph-ct.vue',
    ...
    clientTblOfCtSearchPhrases.insert({
      data: {
        value: 'pulse - edit',
        ctAbbr: 'wc',
        ctToShow: '1time-eachField-1value/vital-signs/sub-cts/pulse/edit-layer/edit-design-1.vue', // El -> Edit layer
