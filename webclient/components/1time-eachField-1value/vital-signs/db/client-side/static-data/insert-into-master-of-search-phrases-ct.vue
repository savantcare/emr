  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'bm',
        ctToShow: '1time-eachField-1value/vital-signs/view-layer/tabs-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'bmcc',
        ctToShow: '1time-eachField-1value/vital-signs/edit-layer/edit-design-1.vue', // El -> Edit layer
