  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'psh',
        ctToShow: '1time-eachField-1value/past-psych-history/view-layer/past-pysch-history-design-1-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'epsh',
        ctToShow: '1time-eachField-1value/past-psych-history/edit-layer/past-pysch-history-edit-design-1.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'dpsh',
        ctToShow: '1time-eachField-1value/past-psych-history/view-layer/deleted.vue',
        displayLocation: 'edit-layer',
        ctWidthInEditLayer: 'large',
      },
    })
