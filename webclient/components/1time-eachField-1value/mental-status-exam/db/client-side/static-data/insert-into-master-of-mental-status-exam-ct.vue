...
<script>
import clientSideTblOfMasterMentalStatusExam from '@/components/1time-eachField-1value/mental-status-exam/db/client-side/structure/master-table-of-mental-status-exam.js'
