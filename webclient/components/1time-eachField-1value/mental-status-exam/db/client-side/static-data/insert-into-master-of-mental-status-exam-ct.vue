...
<script>
import clientTblOfMasterMentalStatusExam from '@/components/1time-eachField-1value/mental-status-exam/db/client-side/structure/master-table-of-mental-status-exam.js'
...
export default {
  ...
  mounted() {
    let i = 1
    clientTblOfMasterMentalStatusExam.insert({
      data: {
