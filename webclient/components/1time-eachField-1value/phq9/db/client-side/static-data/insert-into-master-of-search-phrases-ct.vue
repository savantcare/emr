...
import insertIntoMasterTblOfPhq9DuringInitOfCt from './insert-into-master-of-phq9-ct'
export default {
  components: { insertIntoMasterTblOfPhq9DuringInitOfCt },
  data() {
    return {}
  },
  mounted() {
    clientTblOfCtSearchPhrases.insert({
      data: {
        value: 'phq9',
        ctAbbr: 'h',
        ctToShow: '1time-eachField-1value/phq9/view-layer/grid-with-cards-ct.vue',
    ...
    clientTblOfCtSearchPhrases.insert({
      data: {
        value: 'phq9 edit',
        ctAbbr: 'hc',
        ctToShow: '1time-eachField-1value/phq9/edit-layer/edit-design-1.vue',
