...
cp /gt/sc-prog-repos/emr/webclient/cts/1time-Mrow-1Field/reminder/db/sequalize/phoneNumber.model.js /gt/sc-prog-repos/emr/ptserver/models/
...
# cp /gt/sc-prog-repos/emr/webclient/cts/1time-Mrow-1Field/reminder/db/sequalize/phoneNumber.route.js /gt/sc-prog-repos/emr/ptserver/routes/