...
export default {
  ...
  props: ['firstProp', 'formType'], // firstProp is the ClientIdOfRowToChange
  data() {
    return {
      ...
      dnClientIdOfCopiedRowBeingChanged: -1, // For meaning of -1/null/integer see 1rmf/com-mx/edit-layer.js approx line 15
    }
  },
  computed: {
    cfTimeLineDataAr() {
  ...
  watch: {
    ...
    dnClientIdOfCopiedRowBeingChanged: {
      ...
      async handler(pNVal, pOVal) {
        ...
        if (this.dnClientIdOfRowToChange === -1) return // Firstprop has not copied itself to this.dnClientIdOfRowToChange. Look at date section.
        ...
        if (pNVal === null) {
          ...
          const arOrmRowToChange = clientTbl.find(this.dnClientIdOfRowToChange)
  ...
  methods: {
    ...
    mfGetCopiedRowBeingChangedFldVal(pFldName) {
      ...
      return clientTbl.fnGetFldValue(this.dnClientIdOfCopiedRowBeingChanged, pFldName)
    },
