...
<script>
import initializeRecommendationComponent from '@/components/patient-data/temperature/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
