...
export default class medical_history extends clientTblManage {
  ...
  /* 
    ...
    http://127.0.0.1:8000/medical-history/getAll

    To make post request:
    enter http://127.0.0.1:8000/medical-history/getAll in https://hoppscotch.io/

    Options:
    1. static apiUrl = process.env.baseUrl + '/medical-history'

  */

  static apiUrl = process.env.baseUrlForLumen + '/public/api/medical-history/v20'
