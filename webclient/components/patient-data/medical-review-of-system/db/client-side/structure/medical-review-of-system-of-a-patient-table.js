...
export const medicalReviewOfSystemFormDef = {
  ...
  fieldsDef: [
    ...
    },
    {
      ...
      nameInUi: 'cardiovascular_select',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'gastrointestinal_select',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    ...
    },
    {
      ...
      nameInUi: 'musculoskeletal_select',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
...

    {
      ...
      nameInUi: 'heme_lymphatic_select',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
