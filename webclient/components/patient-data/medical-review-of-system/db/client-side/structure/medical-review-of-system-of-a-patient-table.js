...
export default class medicalReviewOfSystemForPatientClass extends clientTblManage {
  static entity = 'tblMedicalReviewOfSystem'
...
export const medicalReviewOfSystemFormDef = {
  ...
  defaultNormalArray:['#Change_in_weight#','#Dry_skin#','#Seasonal_allergies#','#Shortness_of_breath#','#Shakiness#','#Feeling_hotter_than_everyone#'],
  fieldsDef: [
    {
  ...
  showAllnormalButtonInForm: true,
