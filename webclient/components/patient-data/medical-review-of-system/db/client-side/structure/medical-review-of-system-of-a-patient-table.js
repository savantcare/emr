...
export const medicalReviewOfSystemFormDef = {
  ...
  fieldsDef: [
    ...
    },
    {
      ...
      nameInUi: 'Q6) Eyes/Head: Have you recently had?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'Q7) Respiratory: Do you have?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'Q8) Cardiovascular: Do you have?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'Q9) Gastrointestinal: Do you have?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'Q10) Urinary: Do you have?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },

    {
      ...
      nameInUi: 'Q11) Endocrine: Do you have?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'Q12) Musculoskeletal: Do you have?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'Q13) Neurological: Do you feel?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
    {
      ...
      nameInUi: 'Q14) Psychological: Do you feel?',
      type: 'multi-select-with-buttons',
      showLabel: true,
      style: 'padding: 20px',
    },
