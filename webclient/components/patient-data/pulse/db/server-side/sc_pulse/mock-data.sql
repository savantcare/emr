...
INSERT INTO `pulse`(`serverSideRowUuid`, `ptUuid`, `pulseInBpm`, `timeOfMeasurementInMilliSecs`, `notes`, `recordChangedByUuid`, `recordChangedFromIPAddress`, `recordChangedFromSection`) VALUES
