  ...
  <div>
    ...
    <el-tabs v-model="activeHorizontalTab" tab-position="left">
      ...
      <el-tab-pane label="Depression" name="depression"
        >Depression
        <ctEditFormTemplate :_formDef="formDef" _regexForFieldSubset="depressive.*"></ctEditFormTemplate>
      </el-tab-pane>
      <el-tab-pane label="Mania" name="mania"
        >Mania/Hypomania
        <ctEditFormTemplate :_formDef="formDef" _regexForFieldSubset="mania.*"></ctEditFormTemplate>
      </el-tab-pane>
