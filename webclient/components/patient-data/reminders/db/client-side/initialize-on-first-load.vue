...
<script>
import initializeReminderComponent from '@/components/patient-data/reminders/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientTbl from '~/components/patient-data/reminders/db/client-side/structure/reminders-of-a-patient-table.js'
