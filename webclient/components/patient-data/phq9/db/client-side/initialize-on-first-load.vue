...
<script>
import step1_init_search_phrases from '@/components/patient-data/phq9/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import step2_init_ss_field_names from '@/components/patient-data/phq9/db/client-side/static-data/insert-into-phq9-all-select-options.vue'

import clientTbl from '~/components/patient-data/phq9/db/client-side/structure/phq9-of-a-patient-table.js'
// import step2_init_ss_field_names from '@/components/patient-data/phq9/db/client-side/dynamic-data/get-initial-data-from-server-ct.vue'
