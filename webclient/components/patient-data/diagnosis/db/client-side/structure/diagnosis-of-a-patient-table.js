...
export const diagnosisFormDef = {
  ...
  fieldsDef: [
    ...
    { nameInDb: 'assessment', nameInUi: 'Assessment', type: 'tribute-editor', required: false },
    { nameInDb: 'onset', nameInUi: 'Onset', type: 'date' ,showLabel: false, required: false },
  ],
  ...
  ctrlPlacementOfEveryFieldsNameAndValueInViewNote: 'padding: 0px; margin: 0px; display: grid; grid-template-columns: 1fr 1fr 1fr; grid-column-gap: 1rem',
  validationsObj: {
    value: {
      diagnosis: {
