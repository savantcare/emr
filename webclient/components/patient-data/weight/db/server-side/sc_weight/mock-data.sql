...
INSERT INTO `weight`(`serverSideRowUuid`, `ptUuid`, `weightInPounds`, `timeOfMeasurementInMilliSecs`, `notes`, `recordChangedByUuid`, `recordChangedFromIPAddress`, `recordChangedFromSection`) VALUES
