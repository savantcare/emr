<!-- Master doc is at reference implementation name/view-layer/table.vue. This file has doc unique to this ct 
...
export default {
  ...
  computed: {
    cfAge() {
      ...
      const diff = currentMS - this.cfLatestDataRowFromClientTbl.dateOfBirthInMilliSecs
