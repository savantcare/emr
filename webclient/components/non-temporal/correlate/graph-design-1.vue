...
import clientSideTblOfPatientReminders from '@/components/1time-eachField-multiValues/1-textarea/cts/reminders/db/client-side/structure/reminders-of-a-patient-table.js'
