...
import clientSideTblOfPatientReminders from '@/components/1time-Mrow-1Field/1-textarea/cts/reminders/db/client-side/structure/reminders-of-a-patient-table.js'
