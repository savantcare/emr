...
import clientSideTblOfPatientRecommendations from '@/components/1time-Mrow-1Field/1-textarea/cts/recommendations/db/client-side/structure/recommendations-of-a-patient-table.js'
