...
import clientSideTblOfPatientRecommendations from '@/components/1time-eachField-multiValues/1-textarea/cts/recommendations/db/client-side/structure/recommendations-of-a-patient-table.js'
