<template>
  <!-- SECTION 8  Medical review of systems -->
  <div>
...
<script>
// Data tables
import clientTblOfPatientServiceStatements from '@/components/temporal/service-statement/db/client-side/structure/patient-table-of-service-statements.js'
