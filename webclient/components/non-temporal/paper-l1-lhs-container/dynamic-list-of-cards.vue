...
<script>
import clientTblOfDynamicCards from '@/components/non-temporal/paper-l1-lhs-container/db/client-side/structure/left-hand-side-table-of-cards.js'
import clientTblOfDynamicCardsInsertData from '@/components/non-temporal/paper-l1-lhs-container/db/client-side/static-data/insert-into-left-side-view-layer-cards.vue'
