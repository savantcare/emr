...
*/
  ...
  */
  ...
  static fnGetAllRowsPossibleToPopulateInChangeLayer() {
    /*
        Need
    ...
    */
    const arFromClientTbl = this.query()
      ...
      .where((record) => {
        return (
          (record.vnRowStateInSession.toString().startsWith('1') ||
          record.vnRowStateInSession.toString().startsWith('2')) && 
          record.vnRowStateInSession !== 2
        )
      })
      .get()
