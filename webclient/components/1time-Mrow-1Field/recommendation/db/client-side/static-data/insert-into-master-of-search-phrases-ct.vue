  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'rem',
        ctToShow: '1time-Mrow-1Field/recommendation/view-layer/timeline-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'arem',
        ctToShow: '1time-Mrow-1Field/recommendation/edit-layer/add-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'crem',
        ctToShow: '1time-Mrow-1Field/recommendation/edit-layer/edit-design-1.vue',
        displayLocation: 'edit-layer',
        ctWidthInEditLayer: 'small',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'mcrem',
        ctToShow: '1time-Mrow-1Field/recommendation/edit-layer/medit-design-1.vue',
        displayLocation: 'edit-layer',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'drem',
        ctToShow: '1time-Mrow-1Field/recommendation/view-layer/deleted.vue',
        displayLocation: 'edit-layer',
        ctWidthInEditLayer: 'large',
      },
    })
