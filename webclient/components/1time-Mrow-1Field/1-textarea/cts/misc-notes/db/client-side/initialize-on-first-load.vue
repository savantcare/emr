...
<script>
import initializeRecommendationComponent from '@/components/1time-Mrow-1Field/1-textarea/cts/misc-notes/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientSideTable from '~/components/1time-Mrow-1Field/1-textarea/cts/misc-notes/db/client-side/structure/misc-notes-of-a-patient-table.js'
