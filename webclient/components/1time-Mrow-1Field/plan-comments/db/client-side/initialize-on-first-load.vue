...
<script>
import initializeRecommendationComponent from '@/components/1time-Mrow-1Field/plan-comments/db/client-side/static-data/insert-into-master-of-search-phrases-ct.vue'
import clientSideTable from '~/components/1time-Mrow-1Field/plan-comments/db/client-side/structure/plan-comments-of-a-patient-table.js'
