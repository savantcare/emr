  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'plan-comments',
        ctAbbr: 'rem',
        ctToShow: '1time-Mrow-1Field/plan-comments/view-layer/timeline-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'arem',
        ctToShow: '1time-Mrow-1Field/plan-comments/edit-layer/add-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'crem',
        ctToShow: '1time-Mrow-1Field/plan-comments/edit-layer/edit-design-1.vue',
        displayLocation: 'edit-layer',
        ctWidthInEditLayer: 'small',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'mcrem',
        ctToShow: '1time-Mrow-1Field/plan-comments/edit-layer/medit-design-1.vue',
        displayLocation: 'edit-layer',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'drem',
        ctToShow: '1time-Mrow-1Field/plan-comments/view-layer/deleted.vue',
        displayLocation: 'edit-layer',
        ctWidthInEditLayer: 'large',
      },
    })
