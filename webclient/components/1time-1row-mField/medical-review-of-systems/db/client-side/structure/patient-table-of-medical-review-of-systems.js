...
import pastPsychHistoryMasterClass from './master-table-of-medical-review-of-systems.js'
...
export default class pastPsychHistoryForPatientClass extends clientSideTableManage {
  ...
  static fields() {
    return {
      ...
      /* This field is used to store the value of tblMedicalReviewOfSystemsMaster/pastPsychHistoryMasterId
      ...
      pastPsychHistoryMasterId: this.uid(() => uuidv1()), // This is Medical review of systems ID coming from master table ./master-table-of-medical-review-of-systems.js
