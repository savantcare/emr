...
import pastPsychHistorysMasterClass from './master-table-of-service-statements.js'
const { v1: uuidv1 } = require('uuid')
let count = 0
const intUniqueId = () => ++count

export default class pastPsychHistorysForPatientClass extends clientSideTableManage {
  static entity = 'tblPastPsychHistorysOfPatient'
  ...
  static fields() {
    return {
      ...
      /* This field is used to store the value of tblPastPsychHistorysMaster/pastPsychHistoryMasterId
         E.g: The  tblPastPsychHistorysMaster has:
      ...
      pastPsychHistoryMasterId: this.uid(() => uuidv1()), // This is past psych history ID coming from master table ./master-table-of-service-statements.js
     ...
     If found then I remove those extra rows from master.
      ...
      add-ct.vue/cfGetMasterRowsOfPastPsychHistorysGrouped

      */
      // https://vuex-orm.org/guide/model/relationships.html#one-to-one-inverse
      tblPastPsychHistorysMasterLink: this.belongsTo(
        pastPsychHistorysMasterClass,
