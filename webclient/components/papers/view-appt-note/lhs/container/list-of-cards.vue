...
<script>
import clientTblOfDynamicCards from '@/components/papers/note-view/lhs/container/db/client-side/structure/left-hand-side-table-of-cards.js'
import clientTblOfDynamicCardsInsertData from '@/components/papers/note-view/lhs/container/db/client-side/static-data/insert-into-left-side-view-layer-cards.vue'
