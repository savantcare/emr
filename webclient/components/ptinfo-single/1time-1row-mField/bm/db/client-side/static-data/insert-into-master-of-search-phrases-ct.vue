  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'bm',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/view-layer/tabs-ct.vue', // PtsVl -> Present time state - part of - view layer
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'bmcc',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/edit-layer/edit-design-1.vue', // El -> Edit layer
