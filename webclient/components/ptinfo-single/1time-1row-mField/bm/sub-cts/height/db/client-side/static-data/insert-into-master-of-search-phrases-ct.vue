  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'height',
        ctAbbr: 'h',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/sub-cts/height/view-layer/line-graph-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'height - edit',
        ctAbbr: 'hc',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/sub-cts/height/edit-layer/edit-design-1.vue', // El -> Edit layer
