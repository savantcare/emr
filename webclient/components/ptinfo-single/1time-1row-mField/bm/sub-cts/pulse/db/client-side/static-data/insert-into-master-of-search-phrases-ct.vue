  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'pulse',
        ctAbbr: 'w',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/sub-cts/pulse/view-layer/line-graph-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'pulse - edit',
        ctAbbr: 'wc',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/sub-cts/pulse/edit-layer/edit-design-1.vue', // El -> Edit layer
