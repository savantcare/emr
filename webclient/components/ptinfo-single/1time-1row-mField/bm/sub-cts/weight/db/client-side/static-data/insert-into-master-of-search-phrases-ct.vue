  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'weight',
        ctAbbr: 'w',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/sub-cts/weight/view-layer/line-graph-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        value: 'weight - edit',
        ctAbbr: 'wc',
        ctToShow: 'ptinfo-single/1time-1row-mField/bm/sub-cts/weight/edit-layer/edit-design-1.vue', // El -> Edit layer
