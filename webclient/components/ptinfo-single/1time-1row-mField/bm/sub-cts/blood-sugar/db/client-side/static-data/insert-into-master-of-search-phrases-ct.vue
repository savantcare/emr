  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'bs',
        ctToShow:
          'ptinfo-single/1time-1row-mField/bm/sub-cts/blood-sugar/view-layer/line-graph-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'bsc',
        ctToShow:
          'ptinfo-single/1time-1row-mField/bm/sub-cts/blood-sugar/edit-layer/edit-design-1.vue', // El -> Edit layer
