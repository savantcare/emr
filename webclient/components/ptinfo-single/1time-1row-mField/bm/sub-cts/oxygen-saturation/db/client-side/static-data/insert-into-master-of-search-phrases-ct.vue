  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'w',
        ctToShow:
          'ptinfo-single/1time-1row-mField/bm/sub-cts/oxygen-saturation/view-layer/line-graph-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'wc',
        ctToShow:
          'ptinfo-single/1time-1row-mField/bm/sub-cts/oxygen-saturation/edit-layer/edit-design-1.vue', // El -> Edit layer
