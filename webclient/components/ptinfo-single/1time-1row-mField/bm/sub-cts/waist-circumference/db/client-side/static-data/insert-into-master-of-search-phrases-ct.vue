  ...
  mounted() {
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'wc',
        ctToShow:
          'ptinfo-single/1time-1row-mField/bm/sub-cts/waist-circumference/view-layer/line-graph-ct.vue',
    ...
    clientSideTblOfCtSearchPhrases.insert({
      data: {
        ...
        ctAbbr: 'wcc',
        ctToShow:
          'ptinfo-single/1time-1row-mField/bm/sub-cts/waist-circumference/edit-layer/edit-design-1.vue', // El -> Edit layer
