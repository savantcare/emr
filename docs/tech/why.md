...
2.  **ORM**:
    ...
    Client side [vuex-orm](https://github.com/client-side/vuex-orm)

3.  **elelemt.io** [Pre made components](https://element.eleme.io/#/en-US/component/layout)

4.  **Jest**

5.  **Application folder framework** Industry standard best practives. Decided to use [nuxt](https://nuxtjs.org/guide). This has built in integration with element.io and [vuex-orm](https://github.com/client-side/vuex-orm-examples-nuxt)

6.  GraphQL: So only the required fields are fetched. [vuex-orm-graphql](https://github.com/client-side/plugin-graphql)
