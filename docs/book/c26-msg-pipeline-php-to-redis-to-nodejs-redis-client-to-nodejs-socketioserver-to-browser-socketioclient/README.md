...
1. Message sent from redis Web UI. This is simulating php/lumen sending the publish message. The event name must be same as the function name at: emr/webclient/cts/ptinfo-single/1time-Mrow-1Field/reminder/change-layer/act-on-socket-messages-from-server-ct.vue
...
4. When message from socket is sent a new row gets added /emr/webclient/cts/ptinfo-single/1time-Mrow-1Field/reminder/change-layer/act-on-socket-messages-from-server-ct.vue
