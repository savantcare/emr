...
# tmux new-session -s projectname 'yarn docs-in-dev-mode' \; split-window 'cd webclient; yarn start-dev' \; split-window \; select-layout tiled \;
...
# 1. cd webclient; npm run start-dev
